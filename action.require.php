...
#END_LICENSE
if( !isset($gCms) ) exit;
if( !isset($params['lib']) || $params['lib'] == '' ) return;

if( !is_array($this->_libs) ) $this->_libs = array();
$libs = explode(',',$params['lib']);
foreach( $libs as $lib ) {
  $this->_libs[] = strtolower(trim($lib));
}

// that's it, nothing more.
// remember to call this with nocache attribute.
